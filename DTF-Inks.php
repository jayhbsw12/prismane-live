                    ...
                    <div class="row">
                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                            <div class="sec-title-wrapper">
                                <h2 class="sec-title animation__char_come text-prismane-2">Our DTF Inks Range
                                </h2> <br>
                                <h2 class="sec-title animation__char_come mandarin-title-1 text-prismane-2">我们的DTF油墨系列
                                </h2>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-12  table-responsive">
                                <table class="table table-dark rounded fw-light z-1 position-relative">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Compatible Printheads</td>
                                            <td>Epson i3200 / i1600 / XP600</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="sec-title-wrapper mt-5">
                                ...
                                <span class="text-white fs-1 mandarin-title-2">DTF油墨产品系列</span>
                            </div>
                            ...
                            <div class="sec-title-wrapper mt-5">
                                ...
                                <span class="text-white fs-1 mandarin-title-2">兼容打印机</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div class="sec-title-wrapper">
                                ...
                                <h4 class="sec-title title-anim text-prismane">YOUR RELIABLE DTF INKS PARTNER
                                </h4>
                                <h4 class="sec-title title-anim mandarin-title-1 text-prismane">您可靠的DTF油墨合作伙伴</h4>
                            </div>
