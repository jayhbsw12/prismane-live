...
<style>
    ...
    .dtf-film-benefits .service__item-7 a {
    ...
    @media only screen and (min-width: 768px) and (max-width: 991px) {
        ...
        .dtf-film-benefits::before,
        .dtf-film-benefits::after {
            display: none;
        }

        .dtf-film-benefits .service__items-7 {
            grid-template-columns: repeat(2, minmax(0, 1fr));
        }

        .dtf-film-benefits .service__item-7 {
            min-height: 100%;
            padding: 0 24px 38px;
            margin-bottom: 38px;
        ...
        .dtf-film-benefits .service__item-7::after {
            display: none;
        }

        .dtf-film-benefits .service__item-7:nth-last-child(-n+2) {
            margin-bottom: 0;
            border-bottom: 0;
        }

        .dtf-film-benefits .service__item-7:nth-child(odd) {
            border-right: 1px solid #d7d7d7;
        }

        .dtf-film-benefits .service__title-7 {
            font-size: 26px;
            line-height: 1.25;
            padding-bottom: 18px;
            text-wrap: balance;
        ...
        .dtf-film-benefits .service__title-7 span {
            padding-left: 36px;
        }

        .dtf-film-benefits .service__title-7 span::before {
            width: 26px;
            top: 16px;
        }

        .dtf-film-benefits .service__item-7 p {
            max-width: none;
            font-size: 16px;
            line-height: 1.65;
            padding-bottom: 0;
...
<div id="smooth-wrapper">
    ...
    <div id="smooth-content">
        <main>
            ...
            <!-- Service area start -->
            <section class="service__area-7 dtf-film-benefits pt-130 white-section">
                <div class="container">
                    <div class="row">
