...
<div id="smooth-wrapper">
              ...
              <div class="col-xxl-12">
                ...
                <div class="about__content-wrapper">
                  ...
                  <div class="about__content text-anim">
                    <p><b></b></p>
                    <p>Prismane6 Pte Ltd, based in Singapore, is the international branch of <span class="green-text">Global Nanotech Pvt. Ltd.</span>,
                       India, a company under the umbrella of <span class="green-text">Choksi Exports.</span>
                       <br><br> Established in 1984, the Choksi Group has steadily grown into a global leader in <span class="green-text">organic
                        pigments</span>, <span class="green-text">sublimation inks</span>, <span class="green-text">pigment dispersions</span>, and <span class="green-text">DTF inks</span>. With Prismane6, we extend this 
                        ...
                        we ensure <span class="green-text">faster access,</span> <span class="green-text">localized support,</span> and <span class="green-text">seamless supply</span> for our customers worldwide.</p>
              ...
              <div class="row">
                <div class="col-xxl-4 col-xl-4 col-lg-0 col-md-0">
                  <div class="service__img-wrapper">
                    <img src="assets/imgs/service/1/Organic Pigments.webp" alt="Service Image" class="service__img img-1 active">
                    <img src="assets/imgs/service/1/Sublimations INK.webp" alt="Service Image" class="service__img img-2">
                    <img src="assets/imgs/service/1/Pigment Dispersions.webp" alt="Service Image" class="service__img img-3">
          ...
          <div class="container line g-0 pb-130">
            ...
            <div class="row">
              <div class="col-xxl-12">
                ...
                <div class="about__content-wrapper">
                  <div class="about__content text-anim">
                    <p>At Prismane6, we represent not just products, but the <span class="green-text">trust and values of Global Nanotech 
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="advantage-box">
        ...
        <div class="advantage-content">
          ...
          <div class="text"> Organic pigments, sublimation inks, pigment dispersions, and DTF inks.</div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="advantage-box">
        <div class="icon-wrapper"><img src="assets/imgs/about/1/Reliability & Customer-Focus.svg"></div>
        <div class="advantage-content">
          <div class="title">Reliability & Customer-Focus</div>
          <div class="text">Strong customer-centric approach with consistent quality and reliability.</div>
        </div>
      </div>
    </div>
            ...
            <div class="row top_row">
              ...
              <div class="portfolio__list-1">
                <div class="portfolio__item">
                  <a href="#"><img class="mover" src="assets/imgs/portfolio/1/work 1.webp"
              ...
              <div class="row">
                <div class="col-xxl-5 offset-xxl-7 col-xl-5 offset-xl-7 col-lg-6 offset-lg-6 col-md-6 offset-md-6">
                  <div class="solution__content">
                    ...
                    <p>From our manufacturing base in <b>India</b> to our distribution hub in <b>Singapore</b>, we ensure our 
                    ...
                    <p style="margin-top: 20px;"> Prismane6 is not just a distributor – it is an extension of Global Nanotech Pvt. Ltd., 
