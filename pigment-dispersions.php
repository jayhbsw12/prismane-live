                        ...
                        <div class="col-12 col-lg-6 d-flex align-items-center">
                            <div class="hero__content animation__hero_one pt-0">
                                <div
                                    ...
                                    <p class="text-white">You need it, we Formulate it!</p>
                        ...
                        <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                            <div class="development__wrapper">
                                <div class="development__content">
                                    <p>
                                      <b> GLOJET – U SERIES</b> <br><br> Specially developed range of water-based pigment dispersions for digital inks for textiles. Suitable for inks for wide format, DTG & DTF Printers.
                                    </p>
                                    <p>
                                      <b> GLOJET – M SERIES</b> <br><br>  Specially developed range of water-based pigment dispersions for digital inks for flexible packaging / Graphic Industry. Our products are compatible with most of commonly used binders for flexible packaging inks.
                                    </p>
                                </div>
                                <!-- <ul>
