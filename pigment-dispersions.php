...
<style>
    ...
    .pigment-dispersions-benefits .service__item-7 a {
        display: inline-block;
    }

    @media only screen and (min-width: 768px) and (max-width: 991px) {
        .pigment-dispersions-benefits {
            padding-top: 90px;
            padding-bottom: 20px;
        }

        .pigment-dispersions-benefits::before,
        .pigment-dispersions-benefits::after {
            display: none;
        }

        .pigment-dispersions-benefits .service__items-7 {
            grid-template-columns: repeat(2, minmax(0, 1fr));
        }

        .pigment-dispersions-benefits .service__item-7 {
            min-height: 100%;
            padding: 0 28px 38px;
            margin-bottom: 38px;
        ...
        .pigment-dispersions-benefits .service__item-7::after {
            display: none;
        }

        .pigment-dispersions-benefits .service__item-7:nth-last-child(-n+2) {
            margin-bottom: 0;
            border-bottom: 0;
        }

        .pigment-dispersions-benefits .service__item-7:nth-child(odd) {
            border-right: 1px solid #d7d7d7;
        }

        .pigment-dispersions-benefits .service__title-7 {
            font-size: 28px;
            line-height: 1.25;
            padding-bottom: 18px;
        }

        .pigment-dispersions-benefits .service__title-7 span {
            padding-left: 42px;
        }

        .pigment-dispersions-benefits .service__title-7 span::before {
            width: 32px;
            top: 18px;
        }

        .pigment-dispersions-benefits .service__item-7 p {
            max-width: none;
            font-size: 17px;
            line-height: 1.6;
            padding-bottom: 0;
...
<div id="smooth-wrapper">
    ...
    <div id="smooth-content">
        <main>
            ...
            <!-- Service area start -->
            <section class="service__area-7 pigment-dispersions-benefits pt-130 white-section">
                <div class="container">
                    <div class="row">
