...
<style>
    ...
    .pigments-dyes-benefits .service__item-7 a {
        display: inline-block;
    }

    @media only screen and (min-width: 768px) and (max-width: 991px) {
        .pigments-dyes-benefits {
            padding-top: 90px;
            padding-bottom: 20px;
        }

        .pigments-dyes-benefits::before,
        .pigments-dyes-benefits::after {
            display: none;
        }

        .pigments-dyes-benefits .service__items-7 {
            grid-template-columns: repeat(2, minmax(0, 1fr));
        }

        .pigments-dyes-benefits .service__item-7 {
            min-height: 100%;
            padding: 0 24px 38px;
            margin-bottom: 38px;
        ...
        .pigments-dyes-benefits .service__item-7::after {
            display: none;
        }

        .pigments-dyes-benefits .service__item-7:nth-last-child(-n+2) {
            margin-bottom: 0;
            border-bottom: 0;
        }

        .pigments-dyes-benefits .service__item-7:nth-child(odd) {
            border-right: 1px solid #d7d7d7;
        }

        .pigments-dyes-benefits .service__title-7 {
            font-size: 26px;
            line-height: 1.25;
            padding-bottom: 18px;
            text-wrap: balance;
        ...
        .pigments-dyes-benefits .service__title-7 span {
            padding-left: 36px;
        }

        .pigments-dyes-benefits .service__title-7 span::before {
            width: 26px;
            top: 16px;
        }

        .pigments-dyes-benefits .service__item-7 p {
            max-width: none;
            font-size: 16px;
            line-height: 1.65;
            padding-bottom: 0;
...
<div id="smooth-wrapper">
    ...
    <div id="smooth-content">
        <main>
                    ...
                    <div class="row">
                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                            <div class="sec-title-wrapper">
                                <h2 class="sec-title animation__char_come text-prismane-2">Our Pigments & Dyes Range
                                </h2> <br>
                                <h2 class="sec-title animation__char_come mandarin-title-1 text-prismane-2">我们的颜料和染料系列
                                </h2>
                            </div>
                        </div>
            ...
            <!-- Service area start -->
            <section class="service__area-7 pigments-dyes-benefits pt-130 white-section">
                <div class="container">
                    <div class="row">
