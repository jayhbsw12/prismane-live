                        ...
                        <div class="col-12 col-lg-12 d-flex align-items-center">
                            <div class="hero__content animation__hero_one pt-0">
                                <div
                                    ...
                                    <h1 class="sec-title text-white">Sublimation Dispersions</h1>
                    ...
                    <div class="row">
                        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                            <div class="sec-title-wrapper">
                                <h2 class="sec-title animation__char_come">⁠Sublimation Dispersions</h2>
                            </div>
                        </div>
                        <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                            <div class="development__wrapper">
                                <div class="development__content">
                                    <p>
                                        Ink plays a crucial factor in this as the fade resistance varies from ink to
                                        ink. Depending on the need, selecting the appropriate ink will directly affect
                                        how long your print lasts.
                                    </p>
                                    <p>
                                        In order to have the correct Ink Properties, the Dispersions used have to be
                                        extremely stable and with the best Properties.
                                    </p>
                                </div>
                                <!-- <ul>
